...
async function main() {
  ...
  const alterSql = `
    ALTER TABLE distributor_orders
      ADD COLUMN ship_warehouse_code varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
      ADD COLUMN ship_warehouse_name varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
      ADD COLUMN ship_warehouse_wid int NULL;
  `;
